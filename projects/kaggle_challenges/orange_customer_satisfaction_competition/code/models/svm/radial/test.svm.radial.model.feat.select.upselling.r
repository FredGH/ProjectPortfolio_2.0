...
if(isServerRun){
  ...
  setwd('C:/Users/Fred/Desktop/Studies/MSc-DataScience/Statistical Learning/Assignments/Assignment3/deliverables/merged')
}
...
trainMethod <- function(formula, data, ...) {
  ...
  model = structure(list(svm.tune = svm.tune), class = "SvmRadialModelUpselling") 
  return(model)
}

predict.SvmRadialModelUpselling <- function(model, test.data) {
