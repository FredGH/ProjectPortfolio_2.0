...
model.formula <- as.formula("churn ~ V118+V224+V165+V84+V155+V14+V116+V149+V111+V156+V149+V111+V156")
...
if(isServerRun){
  ...
  #setwd('C:/Users/john/dev/goldsmiths/mlsdm/assignment3')
...
train = train[,c("churn","V118","V224","V165","V84","V155","V14","V116","V149","V111","V156","V149","V111","V156")]
...
trainMethod <- function(formula, data, ...) {
  ...
  model = structure(list(svm.tune = svm.tune), class = "SvmRadialModelChurn") 
  return(model)
}

predict.SvmRadialModelChurn <- function(model, test.data) {
