...
train = train[,c("appetency","V84","V118","V165","V224","V116","V155","V14","V90")]
...
trainMethod <- function(formula, data, ...) {
  ...
  model = structure(list(svm.tune = svm.tune), class = "SvmRadialModelAppetency") 
  return(model)
}

predict.SvmRadialModelAppetency <- function(model, test.data) {
